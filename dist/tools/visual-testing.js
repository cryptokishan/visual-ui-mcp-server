...
export async function handleTakeElementScreenshot(server, args) {
...
export async function handleTakeResponsiveScreenshots(server, args) {
...
export async function handleDetectVisualRegression(server, args) {
...
- Status: ${regressionResult.isDifferent ? "REGRESSION DETECTED" : "NO REGRESSION"}
...
export async function handleUpdateBaseline(server, args) {
...
export async function handleTakeScreenshot(server, args) {
    return await visualTesting.takeScreenshot(args);
}
export async function handleCompareScreenshots(server, args) {
