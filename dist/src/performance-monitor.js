export class PerformanceMonitor {
    ...
    async detectPerformanceRegression(baseline, current) {
        ...
        if (Math.abs(current.coreWebVitals.cls - baseline.coreWebVitals.cls) >
            thresholds.cls) {
        ...
        if (Math.abs(current.coreWebVitals.fid - baseline.coreWebVitals.fid) >
            thresholds.fid) {
        ...
        if (Math.abs(current.coreWebVitals.lcp - baseline.coreWebVitals.lcp) >
            thresholds.lcp) {
        ...
        if (Math.abs(current.timing.loadComplete - baseline.timing.loadComplete) >
        ...
        // Check memory usage
        if (Math.abs(current.memory.usedPercent - baseline.memory.usedPercent) >
